...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~vAxDFLgZ#qI2vCFak82707DmtI5vbESRcyxRWuGSeo-8oFeQVNOU", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
ANTI_DELETE: process.env.ANTI_DELETE || true 
, // make true to use antidelete 
...
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "✅️ Status Viewed by Gift!", // // Input Yours custom...
MODE: process.env.MODE || "private", // Put private or public or inbox or groups
OWNER_NUMBER: process.env.OWNER_NUMBER || "2349052510720", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "𝕿𝖊𝖈𝖍 𝖇𝖗𝖔", // Input Yours custom...(Maintain font for Flow)
...
AUTO_BIO_QUOTE: process.env.AUTO_BIO_QUOTE || "Giftyy creates things that creates other things",
CHAT_BOT: process.env.CHAT_BOT || "false", // Put value to true to enablle for all chats only or inbox to ebanle in pm chats only or groups to enable in groups only else false
WELCOME: process.env.WELCOME || "false",
GOODBYE: process.env.GOODBYE || "false",    
AUTO_READ_MESSAGES: process.env.AUTO_READ_MESSAGES || "false", // Enter value to true for blueticking all messages, or commands for blueticking only commands else false
AUTO_BLOCK: process.env.AeUTO_BLOCK || "212,79", // Add Multiple Country Codes Separated by Comma...
