...
global.caption = "*©𝟐𝟎𝟐𝟒 MELLY 𝐌𝐃 𝐕𝟓*"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*ᴘᴏᴡᴇʀᴇᴅ ʙʏ Melvin ᴛᴇᴄʜ*"; // Input Yours custom...(Maintain font for Flow)
...
OWNER_NAME: process.env.OWNER_NAME || "MELVIN 𝐓𝐄𝐂𝐇", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "MELVIN 𝐓𝐄𝐂𝐇", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "MELVIN-𝐌𝐃💜", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "MELLY-𝐌𝐃", // Input Yours custom...(Maintain font for Flow)
